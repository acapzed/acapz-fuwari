...
연습용으로 재미도 없는 CRUD 사이트를 만드는 것보다 그냥 내가 진짜 필요한 서비스를 만드는 게 도움이 된다고 생각하는 주의라서 도전적인 주제로 개발을 시작하는데, 웹 개발을 잘 모르는 상태에서 무작정 박치기했기 때문에 오래 걸린 것 같다. 예전같았으면 현실적인 기술의 벽에 막혀서 허덕이다가 결국 프로젝트를 놓아버리는 경우가 잦았는데, AI 시대에 들어서면서 모르는것은 즉각적으로 피드백 받을수 있어서 가능했던것 같다.
